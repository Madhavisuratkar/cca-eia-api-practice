...
def trim_drill_down(analysis_sku):
    ...
    # Flatten the MultiIndex columns into a single string with a delimiter
    #analysis_sku_item4['Current instance','Current Annual spend'] = data[data[('EPYC Cloud Cost Advisory Recommendations', 'Current Instance', 'Unnamed: 5_level_2')], data[('EPYC Cloud Cost Advisory Recommendations', 'Current Annual Cost', 'Unnamed: 8_level_2')]]
    # Define your column keys
    columns_to_select = [
...
def generate_ppt(excel_file, email, pptx_template, results_path, password=None):
    try:
        ...
        data = pd.read_excel(excel_file, sheet_name='Recommended-Instance', header=[0, 1, 2])
        ...
        # --------- Recommendations ---------
        item_5a = format_currency(analysis_total.loc[0, ('EPYC Cloud Cost Advisory Recommendations', 'Hourly Cost Optimization', 'Annual Cost ($)')])
        item_5b = format_currency(analysis_total.loc[0, ('EPYC Cloud Cost Advisory Recommendations', 'Modernize', 'Annual Cost ($)')])
        item_5c = format_currency(analysis_total.loc[0, ('EPYC Cloud Cost Advisory Recommendations', 'Modernize & Downsize', 'Annual Cost ($)')])

        item_6a = format_currency(analysis_total.loc[0, ('EPYC Cloud Cost Advisory Recommendations', 'Hourly Cost Optimization', 'Annual Savings ($)')])
        ...
        item_7a = format_currency(analysis_total.loc[0, ('EPYC Cloud Cost Advisory Recommendations', 'Modernize', 'Annual Savings ($)')])
        item_7b = str(analysis_total.loc[0, ('EPYC Cloud Cost Advisory Recommendations', 'Modernize', 'Performance Improvement')]) + "x"

        item_8a = format_currency(analysis_total.loc[0, ('EPYC Cloud Cost Advisory Recommendations', 'Modernize & Downsize', 'Annual Savings ($)')])
        item_8b = str(analysis_total.loc[0, ('EPYC Cloud Cost Advisory Recommendations', 'Modernize & Downsize', 'Performance Improvement')]) + "x"

        current_instance_col = ('EPYC Cloud Cost Advisory Recommendations', 'Current Instance', 'Unnamed: 1_level_2')
        ...
        recommend_1_instance_col = ('EPYC Cloud Cost Advisory Recommendations', 'Hourly Cost Optimization', 'Instance')
        ...
        recommend_2_instance_col = ('EPYC Cloud Cost Advisory Recommendations', 'Modernize', 'Instance')
        ...
        recommend_3_instance_col = ('EPYC Cloud Cost Advisory Recommendations', 'Modernize & Downsize', 'Instance')
